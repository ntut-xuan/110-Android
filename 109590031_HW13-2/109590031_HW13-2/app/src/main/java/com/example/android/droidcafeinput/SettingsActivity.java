...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static final Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                Toast.makeText(preference.getContext(), listPreference.getEntries()[index].toString(), Toast.LENGTH_LONG).show();
    ...
    public static class GeneralPreferenceFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("choose_delivery"));
        }
